...
<br>
		...
		<?php
		$_SESSION['employeeoption']=NULL;
		if(isset($_GET['add'])){
			$_SESSION['employeeoption'] ="add" ;
		}else if(isset($_GET['update'])){
			$_SESSION['employeeoption'] ="update" ;
		}
		else if(isset($_GET['delete'])){
			$_SESSION['employeeoption'] ="delete" ;
		...
		<?php
		if($_SESSION['employeeoption'] == "add"){
		echo '
		Enter info please:
		...
		?>
		<?php
		if($_SESSION['employeeoption'] == "update"){
		echo '
		...
		<?php
		if($_SESSION['employeeoption'] == "delete"){
