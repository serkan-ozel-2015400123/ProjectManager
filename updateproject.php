...
if($_POST['id']!=""){
		$result = $conn->query("UPDATE project SET id = '".$_POST['newid']."', name='".$_POST['name']."', start_date = '".$_POST['startdate']."', estimated_total_work_days = '".$_POST['estimatedtotalworkdays']."', area= '".$_POST['area']."', status='".$_POST['status']."', project_manager_id = '".$_POST['projectmanagerid']."' WHERE project.id = '".$_POST['id']."'");
