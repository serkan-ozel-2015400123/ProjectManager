...
$result = $conn->query("INSERT INTO project (id,name,start_date,estimated_total_work_days,area,status,project_manager_id) VALUES ('".$_POST['id']."','".$_POST['name']."','".$_POST['startdate']."','".$_POST['estimatedtotalworkdays']."','".$_POST['area']."','".$_POST['status']."','".$_POST['projectmanagerid']."')");
